...
/* in file addsub.S */
extern	int		addsub(int, int, int);

/* in file addsubC.c */
extern	int		addsubC(int, int, int);

/* in file testaddsubC.S */
extern	int		testaddsubC(int, int, int);

/* in file addsubv2.S */
extern	int		addsubv2(int, int, int, int *);
...
/* in file createppid.c */
extern  pid32   createppid(void *, uint32, pri16, pid32, char *, uint32, ...);
...
extern 	int32	listancestors(pid32);
...
/* in file wallclkterm.c */
extern	uint32	wallclkterm(uint32);
