...
extern	int		divzerocount;	/* Number of divide by zero error */
	...
	)
{
	...
	static	int		invalidopcount = 0;	/* Number of invalid opcode faults */
...
void	trap0(void) {
	...
	panic("Divide by zero error happened 10 times!");
}